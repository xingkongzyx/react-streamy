...
class GoogleAuth extends React.Component {
	...
	renderAuthButton() {
		if (this.state.isSignedIn === null) return <div>I do not know</div>;
		else if (this.state.isSignedIn === false) return <div>I do not sign in</div>;
		else return <div>Signed In</div>;
	}
